...
async function rateLimit(): Promise<void> {
  ...
  // Set lastCallAt eagerly before the sleep so concurrent callers see the updated
  // timestamp immediately and don't both compute wait=0, violating Nominatim's 1 req/sec policy.
